...
# Canonical defaults for the UI live in frontend/src/components/BvaForm.tsx
# (DEFAULTS). Defaults here are only used by direct API callers (curl, tests,
# integrations) — keep them in sync when the frontend values change.
